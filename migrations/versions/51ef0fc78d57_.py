...
Revision ID: 51ef0fc78d57
Revises: fd3504ba74e1
Create Date: 2021-08-25 11:44:40.022969
...
revision = '51ef0fc78d57'
down_revision = 'fd3504ba74e1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('accounting_record', sa.Column('note', sa.String(length=20), nullable=True))
    op.add_column('sale_record', sa.Column('note', sa.String(length=20), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('sale_record', 'note')
    op.drop_column('accounting_record', 'note')
