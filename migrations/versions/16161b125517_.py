...
Revision ID: 16161b125517
Revises: 4b60706761c2
Create Date: 2021-03-16 16:31:34.218070
...
revision = '16161b125517'
down_revision = '4b60706761c2'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('QIR_numbers_preview', sa.Column('code_number', sa.VARCHAR(length=10), autoincrement=False, nullable=True))
